...
export function DataExplorer({
  ...
  return (
    <aside className="flex h-full w-[272px] shrink-0 flex-col overflow-hidden border-r border-[#e3e6e8] bg-white">
      <div className="overflow-hidden border-b border-[#e3e6e8] bg-white">
