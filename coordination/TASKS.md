...
- Registry revision: `319`
- Updated: `2026-09-04T03:13:42Z`
- Source main snapshot: `ca18a092552a0037e33ef4945c8c2d99ae487b38`
- Legacy/inactive rows retained in JSON for migration compatibility: `8`
...
| `X-A1-EXPORT-JOB-API` | L3 | **running** | `agent-x-a1-242` | #242 | `agent/issue-242-x-a1-export-job-api` | branch:agent/issue-242-x-a1-export-job-api, api:export-job, storage:export-read-gc |

## Active locks

| Lock | Task | Owner | Lease expires |
| --- | --- | --- | --- |
| `api:export-job` | `X-A1-EXPORT-JOB-API` | `agent-x-a1-242` | `2026-09-04T07:13:42Z` |
| `branch:agent/issue-242-x-a1-export-job-api` | `X-A1-EXPORT-JOB-API` | `agent-x-a1-242` | `2026-09-04T07:13:42Z` |
| `storage:export-read-gc` | `X-A1-EXPORT-JOB-API` | `agent-x-a1-242` | `2026-09-04T07:13:42Z` |
