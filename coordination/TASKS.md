...
- Registry revision: `346`
- Updated: `2026-09-04T10:54:22Z`
...
| `OPS-O1` | L3 | **queued** | `—` | #256 | `agent/issue-256-ops-o1-observability` | branch:agent/issue-256-ops-o1-observability, core:telemetry, api:observability, storage:observability |
