...
- Registry revision: `344`
- Updated: `2026-09-04T09:51:57Z`
- Source main snapshot: `ca18a092552a0037e33ef4945c8c2d99ae487b38`
- Legacy/inactive rows retained in JSON for migration compatibility: `14`
...
| `SEC-A1` | L3 | **running** | `codex-sec-a1-20260904` | #254 | `agent/issue-254-sec-a1-rbac-api` | branch:agent/issue-254-sec-a1-rbac-api, api:authorization, gate:sec-rbac |

## Active locks

| Lock | Task | Owner | Lease expires |
| --- | --- | --- | --- |
| `api:authorization` | `SEC-A1` | `codex-sec-a1-20260904` | `2026-09-04T13:51:57Z` |
| `branch:agent/issue-254-sec-a1-rbac-api` | `SEC-A1` | `codex-sec-a1-20260904` | `2026-09-04T13:51:57Z` |
| `gate:sec-rbac` | `SEC-A1` | `codex-sec-a1-20260904` | `2026-09-04T13:51:57Z` |
