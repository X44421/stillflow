...
- Registry revision: `389`
- Updated: `2026-09-12T09:16:27Z`
...
| `NX-N2` | L3 | **queued** | `—` | #341 | `agent/issue-341-nx-n2` | branch:agent/issue-341-nx-n2, core:composite-definitions, plan:composite-expansion |
