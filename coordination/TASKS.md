...
- Registry revision: `343`
- Updated: `2026-09-04T09:51:48Z`
...
| `SEC-A1` | L3 | **queued** | `—` | #254 | `agent/issue-254-sec-a1-rbac-api` | branch:agent/issue-254-sec-a1-rbac-api, api:authorization, gate:sec-rbac |
