...
- Registry revision: `384`
- Updated: `2026-09-12T08:01:34Z`
...
| `NX-A1` | L3 | **queued** | `—` | #338 | `agent/issue-338-nx-a1` | branch:agent/issue-338-nx-a1, core:node-graph-decoding, plan:compile-diagnostics, api:node-graph-error-envelope |
