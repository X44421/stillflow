...
- Registry revision: `390`
- Updated: `2026-09-12T11:53:09Z`
- Source main snapshot: `ca18a092552a0037e33ef4945c8c2d99ae487b38`
- Legacy/inactive rows retained in JSON for migration compatibility: `29`
...
| `NX-N2` | L3 | **running** | `agent-nx-n2-341` | #341 | `agent/issue-341-nx-n2` | branch:agent/issue-341-nx-n2, core:composite-definitions, plan:composite-expansion |

## Active locks

| Lock | Task | Owner | Lease expires |
| --- | --- | --- | --- |
| `branch:agent/issue-341-nx-n2` | `NX-N2` | `agent-nx-n2-341` | `2026-09-12T13:23:09Z` |
| `core:composite-definitions` | `NX-N2` | `agent-nx-n2-341` | `2026-09-12T13:23:09Z` |
| `plan:composite-expansion` | `NX-N2` | `agent-nx-n2-341` | `2026-09-12T13:23:09Z` |
