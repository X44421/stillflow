...
| --- | --- | --- | --- |
| `branch:agent/issue-252-sec-s1-identity-credential` | `SEC-S1` | `codex-sec-s1-20260904` | `2026-09-04T13:27:38Z` |
| `gate:sec-identity` | `SEC-S1` | `codex-sec-s1-20260904` | `2026-09-04T13:27:38Z` |
| `storage:identity` | `SEC-S1` | `codex-sec-s1-20260904` | `2026-09-04T13:27:38Z` |
