...
- Registry revision: `393`
- Updated: `2026-09-13T03:42:16Z`
- Source main snapshot: `ca18a092552a0037e33ef4945c8c2d99ae487b38`
- Legacy/inactive rows retained in JSON for migration compatibility: `30`
...
| `NX-V1` | L3 | **running** | `agent-nx-v1-343` | #343 | `agent/issue-343-nx-v1` | branch:agent/issue-343-nx-v1, storage:control-plane, api:graph-revisions |

## Active locks

| Lock | Task | Owner | Lease expires |
| --- | --- | --- | --- |
| `api:graph-revisions` | `NX-V1` | `agent-nx-v1-343` | `2026-09-13T05:12:16Z` |
| `branch:agent/issue-343-nx-v1` | `NX-V1` | `agent-nx-v1-343` | `2026-09-13T05:12:16Z` |
| `storage:control-plane` | `NX-V1` | `agent-nx-v1-343` | `2026-09-13T05:12:16Z` |
